...
import static com.paysphere.TradeConstant.JOB_NAME_T2_PAY_SETTLE;
...
@Slf4j
@Component
public class T2SettleOrderPayJob extends AbstractSettlePayJob {
    ...
    public void handler() {
        ...
        try {
            ...
            rocketMqProducer.syncSendExceptionMessage("T2结算, 任务异常:" + e.getMessage());
            return;
        }
