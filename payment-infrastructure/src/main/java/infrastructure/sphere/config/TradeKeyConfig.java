...
public class TradeKeyConfig {
    ...
    public String parsePrivateKey() {
        Assert.notBlank(this.getKey(), () -> new PaymentException(ExceptionCode.SYSTEM_ERROR, "Trade Private " +
                "key miss"));
        Assert.notBlank(this.getTrade(), () -> new PaymentException(ExceptionCode.SYSTEM_ERROR, "Trade Private" +
                " key password miss"));
        try {
            ...
            throw new PaymentException(ExceptionCode.SYSTEM_ERROR, "Trade parse private key exception");
        }
    }
