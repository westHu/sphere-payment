...
public class RSAUtils {
    ...
    public static Map<String, String> initKeyBase64Str() throws Exception {
        ...
        logger.info("生成密钥 = " + JSONUtil.toJsonStr(map));
        return map;
    }
    ...
    public static String encrypt(String str, String publicKey) throws Exception {
        ...
        RSAPublicKey pubKey =
                (RSAPublicKey) KeyFactory.getInstance(KEY_ALGORITHM).generatePublic(new X509EncodedKeySpec(decoded));
        // RSA加密
    ...
    public static String decrypt(String str, String privateKey) throws Exception {
        ...
        RSAPrivateKey priKey =
                (RSAPrivateKey) KeyFactory.getInstance(KEY_ALGORITHM).generatePrivate(new PKCS8EncodedKeySpec(decoded));
        // RSA解密
        Cipher cipher = Cipher.getInstance(KEY_ALGORITHM);
    ...
    public static String encryptByPublicKey(String str, String publicKey) throws Exception {
        ...
        RSAPublicKey pubKey =
                (RSAPublicKey) KeyFactory.getInstance(KEY_ALGORITHM).generatePublic(new X509EncodedKeySpec(keyBytes));
        // RSA加密
        Cipher cipher = Cipher.getInstance(KEY_ALGORITHM);
        cipher.init(Cipher.ENCRYPT_MODE, pubKey);
    ...
    public static String doSign(String content, String privateKey, String encode) {
        try {
            ...
            logger.error("RSA doSign exception:", e);
        }
        return null;
    }
    ...
    public static boolean doCheck(String content, String signed, PublicKey publicKey, String encode) {
        try {
            ...
            logger.error("RSA doCheck exception:", e);
        }
        return false;
    }
     ...
     * @param encode        编码
     */
    public static String signToMerchant(String content, String privateKeyStr, String encode) {
        try {
            // String unsigned = Base64.encodeBase64String(content.getBytes(encode));
