...
public enum AccountFlowDescEnum {
     ...
     * 商户
     */
    MERCHANT_INCOME_PAY("商户收入:商户收款", AccountDirectionEnum.INCOME),
    MERCHANT_EXPEND_FEE("商户支出:商户手续费", AccountDirectionEnum.EXPEND),
    MERCHANT_EXPEND_CASH("商户支出:商户出款", AccountDirectionEnum.EXPEND),
     ...
     * 平台
     */
    PLATFORM_INCOME_PAY_FEE(" 平台收入:收款-商户手续费", AccountDirectionEnum.INCOME),
    PLATFORM_EXPEND_PAY_CHANNEL(" 平台支出:收款-通道成本", AccountDirectionEnum.EXPEND),

    PLATFORM_INCOME_CASH_FEE(" 平台收入:出款-商户手续费", AccountDirectionEnum.INCOME),
    PLATFORM_EXPEND_CASH_CHANNEL(" 平台支出:出款-通道成本费用", AccountDirectionEnum.EXPEND),
     ...
     * 代理商
     */
    AGENT_INCOME_PAY_PROFIT(" 代理商收入:收款-代理商分润", AccountDirectionEnum.INCOME),
    AGENT_INCOME_CASH_PROFIT(" 代理商收入:出款-代理商分润", AccountDirectionEnum.INCOME),
