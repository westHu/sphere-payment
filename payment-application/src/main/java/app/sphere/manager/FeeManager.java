...
public class FeeManager {
    ...
    public BigDecimal calculateActualAmount(DeductionTypeEnum deductionTypeEnum,
        ...
        if (DeductionTypeEnum.DEDUCTION_INTERNAL.equals(deductionTypeEnum)) {
            ...
            throw new PaymentException("BIZ_UNSUPPORTED_DEDUCTION_TYPE");
        }
     ...
     * 校验代收平台利润
     */
    public void verifyPayPlatformProfit(TradePaymentOrder payOrder) {
        if (Objects.isNull(payOrder)) {
            throw new PaymentException("verify pay transaction profit");
        }
     ...
     * 校验代付平台利润
     */
    public void verifyCashPlatformProfit(TradePayoutOrder cashOrder) {
        if (Objects.isNull(cashOrder)) {
            throw new PaymentException("verify cash transaction profit");
        }
    ...
    public void verifyWithdrawPlatformProfit(TradeWithdrawOrder withdrawOrder) {
        if (Objects.isNull(withdrawOrder)) {
            throw new PaymentException("verify withdraw transaction profit");
        }
